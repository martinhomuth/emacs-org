...
I am learning hungarian and I need some vocabulary trainer for some of
the words I still can't remember. I found org-drill might be what I am
  ...
  (use-package flycheck
    ...
    (add-hook 'c-mode-hook
              (lambda () (setq flycheck-gcc-include-path
                               (list (expand-file-name "/usr/src/linux-headers-3.13.0-37-generic/include/y"))))))
#+END_SRC
