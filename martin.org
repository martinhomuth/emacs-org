...
#+BEGIN_SRC elisp
(load "~/.emacs.d/emacs.secrets" t t t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defun my-show-trailing-whitespaces-func ()
    (interactive)
    "This function shall be called whenever a buffer is entered and
  the buffer-local variable 'show-trailing-whitespace' is set."
    (setq show-trailing-whitespace t))
  (add-hook 'c-mode-hook 'my-show-trailing-whitespaces-func)
  (add-hook 'c-mode-common-hook 'my-show-trailing-whitespaces-func)
  (add-hook 'c++-mode-hook 'my-show-trailing-whitespaces-func)
  (add-hook 'makefile-mode 'my-show-trailing-whitespaces-func)
  (add-hook 'sh-mode 'my-show-trailing-whitespaces-func)
  (add-hook 'shell-mode 'my-show-trailing-whitespaces-func)
#+END_SRC
...
#+BEGIN_SRC elisp
  ...
  (add-to-list 'tramp-default-method-alist '("magi" "martin" "ssh"))
#+END_SRC

#+RESULTS:
| magi              | martin         | ssh        |                 |          |    |
| nil               | %              | smb        |                 |          |    |
| \`\(127\.0\.0\.1\ | ::1\           | balthasar\ | localhost6?\)\' | \`root\' | su |
