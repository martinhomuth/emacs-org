...
#+BEGIN_SRC emacs-lisp :export no
  ...
  (setq org-publish-project-alist
        '(
          ...
          ("org-notes"
           :base-directory (concat (getenv "HOME") "/git/CG_bitbucket/blog/org/")
           :base-extension "org"
           :publishing-directory (concat (getenv "HOME") "/git/CG_bitbucket/blog/public_html/")
           :recursive t
          ...
          ("org-static"
           :base-directory "~/git/CG_bitbucket/blog/org/"
           :base-extension "css\\|js\\|png\\|jpg\\|gif\\|pdf\\|mp3\\|ogg\\|swf"
           :publishing-directory "~/git/CG_bitbucket/blog/public_html/"
           :recursive t
  ...
  (use-package org-caldav
    ...
    (setq org-caldav-calendars
          '((:calendar-id "personal"
                          :files
			  ((concat (getenv "HOME") "/git/CG_bitbucket/org/personal.org")
			   (concat (getenv "HOME") "/git/CG_bitbucket/org/organizer.org")
			   (concat (getenv "HOME") "/git/CG_bitbucket/org/journal.org"))
                          :inbox
			  (concat (getenv "HOME") "/git/CG_bitbucket/org/inbox/frompersonal.org"))
            (:calendar-id "work"
                          :files
			  ((concat (getenv "HOME") "/git/CG_bitbucket/org/work.org"))
                          :inbox
			  (concat (getenv "HOME") "/git/CG_bitbucket/org/inbox/fromwork.org")))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'c-mode-hook
		...
		(when (and filename
                           (string-match (expand-file-name (concat (getenv "HOME") "/src/linux-trees"))
					 filename))
                  (setq indent-tabs-mode t)
                  (setq show-trailing-whitespace t)
