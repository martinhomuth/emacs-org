...
#+BEGIN_SRC emacs-lisp
(load (expand-file-name"~/.emacs.d/secrets"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; special hl-line when using tao theme
  (if (equal custom-enabled-themes '(tao-yang))
      (set-face-attribute 'hl-line nil
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        `(("t" "Tasks" entry
           (file+headline (expand-file-name "~/git/CG_bitbucket/org/personal.org") "INBOX")
          ...
          ("j" "Journal entry" plain
           (file+olp+datetree (expand-file-name "~/git/CG_bitbucket/org/journal.org"))
           ,martin/org-journal-template)
          ("a" "Appointments" entry
           (file+headline (expand-file-name "~/git/CG_bitbucket/org/organizer.org") "Appointments")
           "* %?\n%i")
          ("d" "Decisions" entry
           (file+headline (expand-file-name "~/git/CG_bitbucket/org/personal.org") "Decisions")
           "* %?\n%i")
          ("p" "Project" entry
           (file+headline (expand-file-name "~/git/CG_bitbucket/org/personal.org") "Projects")
           ,martin/org-project-template)
          ("W" "Workout" entry
           (file+headline (expand-file-name "~/git/CG_bitbucket/org/personal.org") "Primary Skills")
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package flymake-jslint
    :ensure t
    :config
    (add-to-list 'load-path (expand-file-name (getenv "HOME") "/git/lintnode"))
    (setq lintnode-location (expand-file-name (getenv "HOME") "/git/lintnode"))
