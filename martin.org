...
#+BEGIN_SRC emacs-lisp
  (setq org-directory (concat (file-truename "~/git") "/CG_bitbucket/org"))
  (setq org-default-notes-file (concat (file-truename "~/git") "/CG_bitbucket/org/personal.org"))
#+END_SRC
  ...
  (setq org-capture-templates
        `(("t" "Tasks" entry
          ...
          ("j" "Journal entry" plain
           (file+olp+datetree (file-truename "~/git/CG_bitbucket/org/journal.org"))
